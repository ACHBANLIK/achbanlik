...
@push('scripts')
  ...
  <script>
    ...
    $(document).on("click", ".addFriend", function(event) {
            id = $(this).attr('id');
            Friend('/addfriend/pubs/one/'+id , "Demande envoyée.");   
    });

    $(document).on("click", ".deleteFriend", function(event) {
            id = $(this).attr('id');
            Friend('/deletefriend/pubs/one/'+id , "Ami(e) supprimé(e).");   
    });


    $(document).on("click", ".cancelFriend", function(event) {
            id = $(this).attr('id');
            Friend('/cancelfriend/pubs/one/'+id , "Demande annulée.");     
    });

    $(document).on("click", ".acceptFriend", function(event) {
            id = $(this).attr('id');
            Friend('/acceptfriend/pubs/one/'+id , "Demande acceptée.");     
    });

    $(document).on("click", ".declineFriend", function(event) {
            id = $(this).attr('id');
            Friend('/declinefriend/pubs/one/'+id , "Demande Refusée.");     
    });
